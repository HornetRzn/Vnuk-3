    ...
    switch(session.step) {
      ...
      default:
        await ctx.reply(getRandomResponse([
          "Что ты мне тут втираешь-то? Я же не с тобой разговариваю 💁🏼‍♂️ ну имей совесть",
          "Я тебя не понял. Дай с человеком договорить."
        ]), replyOpt);
    }
  }
});
